...
import { loadData, escapeHtml, NAV_LINKS } from './qrs-data.js';
    ...
    return `
        <div class="footer-subgroup">
            ...
            <nav class="footer-links">
                ${items.map(item => `<a href="${escapeHtml(item.url)}" target="_blank" rel="noopener noreferrer" class="footer-link">${escapeHtml(item.name)}<i data-lucide="arrow-up-right" class="h-3.5 w-3.5"></i></a>`).join('')}
            </nav>
        </div>`;
}
...
async function renderFooter() {
    ...
    const exploreLinksHTML = NAV_LINKS
    ...
    footer.innerHTML = `
        <div class="container mx-auto px-6 py-10">
            <div class="footer-columns">
                <div class="footer-col footer-col-brand">
                    <div class="footer-brand">
                        ...
                        <span class="footer-brand-name">QRS@NTU</span>
                    </div>
                    <p class="footer-blurb">Quantitative research, technical learning, and industry activity at NTU.</p>
            ...
            <div class="footer-bottom">
                ...
                <p class="footer-copyright"><a href="${root}contact/">Contact</a> &middot; &copy; <span id="footer-year"></span> QRS@NTU. All Rights Reserved.</p>
            </div>
        </div>`;
