...
import { loadData, personRefs, escapeHtml } from '../v1/assets/qrs-data.js';

async function renderHome() {
    try {
        const { projects, publications, events, people } = await loadData({
            projects: '../v1/data/projects.json',
            publications: '../v1/data/publications.json',
            events: '../v1/data/events.json',
            people: '../v1/data/people.json',
        });
